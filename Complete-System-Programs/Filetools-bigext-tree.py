...
#  we can pass in a directory name, extension type, and trace level
#  on the command-line now (trace level 0 disables tracing, and 1, the default, shows
#  directories visited along the way):
#  C:\PP4E\System\Filetools>python bigext-tree.py .. .py 0
#  C:\PP4E\System\Filetools>python bigext-tree.py .. .txt 1
#  C:\PP4E\dev\Examples\PP4E\System\Filetools>python bigext-tree.py C:\
